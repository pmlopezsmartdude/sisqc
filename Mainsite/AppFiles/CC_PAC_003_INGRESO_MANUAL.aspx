<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CC_PAC_003_INGRESO_MANUAL.aspx.cs" Inherits="Mainsite.AppFiles.CC_PAC_003_INGRESO_MANUAL" %>
...
<body>
 ...
 <asp:Panel ID="Panel1" runat="server">
   <asp:Table ID="Datos" runat="server" Width="100%" Height="100%" Font-Names="Century Gothic" Font-Size="Small" HorizontalAlign="Center">
        ...
        <asp:TableCell Width="60">
            ...
            <asp:TableCell Width="60">
                 ...
                 <asp:DropDownList ID="DDL_turno_d"  runat="server" Width="120" DataSourceID="DDL_turno" DataTextField="turno" DataValueField="turno" Height="26"  Font-Names="Century Gothic" AutoPostBack="True" onselectedindexchanged="turno_SelectedIndexChanged"> </asp:DropDownList>
               </asp:TableCell>
              <asp:TableCell Width="60">
                <asp:Label ID="lbl_cod_plan" runat="server" Text="Código Planta" Width="80" Height="30"></asp:Label>
            </asp:TableCell>
     <asp:TableCell Width="60">
   ...
   <asp:TableCell Width="60">
                <asp:Label ID="lbl_cod_proc" runat="server" Text="Código Proceso" Width="80" Height="30"></asp:Label>
            </asp:TableCell>
     <asp:TableCell Width="60">
              <asp:Textbox MaxLength="5" ID="NroProceso" runat="server"   Width="116" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:Textbox> </asp:TableCell>
           
              <asp:TableCell Width="60">
            <asp:Label ID="lblLote" runat="server" Text="Lote" Width="80" Height="30"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="60">
                  ...
                  <asp:TextBox MaxLength="5" ID="Lote" runat="server"   Width="116" Height="20" Enabled="true" Font-Size="X-Small" Font-Names="Century Gothic"></asp:TextBox>
                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender37" TargetControlID="Lote" FilterType="numbers"  runat="server" />
               </asp:TableCell>
      ...
      <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="30">
   <asp:TableCell Width="60">
                <asp:Label ID="Label37" runat="server" Text="Productor" Width="80" Height="30"></asp:Label>
            </asp:TableCell>
     <asp:TableCell Width="60">
             <asp:DropDownList ID="DDL_prodreal_d"  runat="server" Width="120" DataSourceID="DDL_prodreal" DataTextField="DESCRIPCION" DataValueField="DESCRIPCION" Height="26"  Font-Names="Century Gothic" AutoPostBack="True" onselectedindexchanged="prodreal_SelectedIndexChanged" > </asp:DropDownList>
             </asp:TableCell>
          
              <asp:TableCell Width="60">
            <asp:Label ID="Label40" runat="server" Text="Variedad" Width="80" Height="30"></asp:Label>
            </asp:TableCell>
            <asp:TableCell Width="60">
          <asp:DropDownList ID="DDL_variedad_d"  runat="server" Width="120" DataSourceID="DDL_variedad" DataTextField="VARDESC" DataValueField="VARDESC" Height="26"  Font-Names="Century Gothic" AutoPostBack="True"  onselectedindexchanged="variedad_SelectedIndexChanged"> </asp:DropDownList>
              </asp:TableCell>
   ...
   <asp:TableCell Width="60">
     ...
     <asp:TableCell Width="60"> <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="NroProceso" CssClass="failureNotification" Font-Size="x-Small"  ErrorMessage="Ingrese Proceso"  ValidationGroup="ChangeUserPasswordValidationGroup"/>
              </asp:TableCell>
            ...
            <asp:TableCell Width="60">
              <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Lote" CssClass="failureNotification" Font-Size="x-Small"  ErrorMessage="Ingrese Lote"  ValidationGroup="ChangeUserPasswordValidationGroup"/></asp:TableCell>
   ...
   <asp:Table ID="Table3" runat="server" Width="100%" Height="100%" Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Center">
     <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
...
<asp:TabPanel runat="server" HeaderText="EXPORTABLE" ID="PANEL_EXPORTABLE"  Enabled ="true" >
    <ContentTemplate>
     ...
     <asp:Table ID="Table4" runat="server" Width="70%" Height="100%" Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Left">
     <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label38" runat="server" Text="" Height="20"></asp:Label> 
             </asp:TableCell>
             <asp:TableCell Width="30">
                <asp:Label ID="Label39" runat="server" Text="QC" Height="20"></asp:Label> </asp:TableCell>

             <asp:TableCell Width="30">
             <asp:Label ID="Label41" runat="server" Text="COMP" Height="20"></asp:Label>
             </asp:TableCell>
            
       </asp:TableRow>
       <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label42" runat="server" Text="% Fruta Comercial <10% Sin Pudrición" ></asp:Label>
             </asp:TableCell>
             <asp:TableCell Width="30">
          ...
          <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="30">
             <asp:TableCell Width="30">
            <center> <asp:Label ID="Label43" runat="server" Text="% Desecho < a 2%" Height="20"></asp:Label></center>
             </asp:TableCell>
           <asp:TableCell Width="30">
...
<asp:TabPanel runat="server" HeaderText="COMERCIAL" ID="PANEL_COMERCIAL"  Enabled ="true" >
    <ContentTemplate>
     ...
     <asp:Table ID="Table6" runat="server" Width="70%" Height="100%" Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Left">
     <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
       ...
       <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label47" runat="server" Text="% Exportable"  Height="20"></asp:Label>
             </asp:TableCell>
             <asp:TableCell Width="30">
          ...
          <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="30">
             <asp:TableCell Width="30">
            <center> <asp:Label ID="Label48" runat="server" Text="% Desecho < a 2%" Height="20"></asp:Label></center>
             </asp:TableCell>
           <asp:TableCell Width="30">
...
<asp:TabPanel runat="server" HeaderText="DESECHO" ID="PANEL_DESHECHO"  Enabled ="true" >
    <ContentTemplate>
     ...
     <asp:Table ID="Table7" runat="server" Width="70%" Height="100%" Font-Names="Century Gothic" Font-Size="x-Small" HorizontalAlign="Left">
         <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label31" runat="server" Text="N° Frutos"  Height="20"></asp:Label>
             </asp:TableCell>
             <asp:TableCell Width="30">
       ...
       <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label52" runat="server" Text="% Exportable < 2%" Height="20"></asp:Label>
             </asp:TableCell>
             <asp:TableCell Width="30">
            ...
            <asp:TableRow HorizontalAlign="Center" VerticalAlign="Middle" Height="20">
             <asp:TableCell Width="30">
             <asp:Label ID="Label32" runat="server" Text="% Comercial < 5%" Height="20"></asp:Label>
             </asp:TableCell>
             <asp:TableCell Width="30">
