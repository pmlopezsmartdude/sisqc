<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HeadInformeCCCereza.aspx.cs" Inherits="Mainsite.MainApp.HeadInformeCCCereza" %>
...
<body>
    ...
    <div>
     <asp:Table ID="Table1" runat="server" Width="100%" Height="30px">
    <asp:TableRow>
    <asp:TableCell>
