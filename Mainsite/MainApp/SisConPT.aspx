<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SisConPT.aspx.cs" Inherits="Mainsite.MainApp.SisConPT" %>
...
<asp:TableCell Width="100%" Height="50px">
    <iframe id="DropDown" runat="server" src="DropDownCC.aspx" style="display:block; width:100%; height:100%; border:none; margin:0; padding:0;" ></iframe>
</asp:TableCell>
</asp:TableRow>
