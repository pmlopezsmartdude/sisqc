...
<asp:ToolkitScriptManager ID="ToolkitScriptManager2" runat="server">  </asp:ToolkitScriptManager>  
  ...
  <asp:DropDownList ID="ddl_lote_d"  runat="server" Width="80" DataSourceID="ddl_lote" DataTextField="lote" DataValueField="lote" Font-Names="Century Gothic" AutoPostBack="True" onselectedindexchanged="lote_SelectedIndexChanged"> </asp:DropDownList>
       ...
       <center>  <asp:ImageButton ID="Reporte005" runat="server" ImageUrl="~/Images/CCPAC005.png" CommandName="Select"  AlternateText="Seleccionar" Height="36px" ImageAlign="AbsMiddle" OnClick="Click_005" ValidationGroup="IngresoFechaGroup"/></center>

        </fieldset>

         <center>  <asp:TextBox   ID="texto" runat="server" Height="120" Width="600" Font-Size="X-Small" Font-Names="Century Gothic" TextMode="MultiLine">0</asp:TextBox></center>
